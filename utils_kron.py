...
COLS = [
    ...
    'CH', 'CH2', 'CH2CHO', 'CH2CO', 'CH2O', 'CH2OH', 'CH2S', 'CH3',
    'CH3CHO', 'CH3O', 'CH3OH', 'CH4', 'CO', 'CO2', 'epsilon',
    'H', 'H2', 'H2O', 'H2O2', 'HCCO', 'HCCOH', 'HCO', 'HO2',
...
def run_pod(T_train_s, energy_threshold=0.99):
    """
...
def fit_residual_gpr(params_train, T_train, core, factors,
    ...
    print(f'  Residual POD rank: {r_res}  '
          f'(max residual norm: {np.linalg.norm(residuals, axis=(1,2,3)).max():.4f})')
